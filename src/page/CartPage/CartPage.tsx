        ...
        <div className="lg:col-span-8 space-y-6">
          {cartList.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-11.5 bg-zinc-50 rounded-2xl border-1 border border-zinc-200">
              ...
              <p className="hidden uppercase sm:block text-sm text-zinc-500 mb-8 font-medium">
                Looks like your cart is empty
              </p>

              <Link
                to="/"
                className="relative z-10 inline-flex items-center justify-center min-w-[180px] h-12 bg-zinc-900 text-white px-8 rounded-lg font-black text-xs uppercase tracking-widest hover:bg-primary transition-all active:scale-[0.98] duration-500 cursor-pointer"
              >
